...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h4 class="m-t-3">강의실 레코더 목록</h4>
            <p class="m-b-2"><kbd>상세정보</kbd> 버튼을 클릭하여 강의실 레코더의 상세한 정보를 볼 수 있습니다.</p>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="v-a-m"><span class="text-white">삼성</span></td>
                        <td class="v-a-m"><span class="text-white">GNV-480N</span>
                        </td>
                        <td class="v-a-m"><i class="fa fa-circle-o text-danger m-r-1"></i> <span class="text-white">고장</span>
                        </td>
                        <td class="text-right v-a-m">
                            <a class="btn btn-default" href="<?=site_url('rooms/videos/get/')?>">
                                상세정보
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="v-a-m"><span class="text-white">LG</span></td>
                        <td class="v-a-m"><span class="text-white">LGV-8108M</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="v-a-m"><span class="text-white">LG</span></td>
                        <td class="v-a-m"><span class="text-white">LGV-9109L</span>
                        </td>
